...
final class Story
{
    ...
    function getElements()
    {
        ...
        foreach ($lines = file($this->path) as $line) {
            ...
            switch ($line) {
                case 'GET {':
                    $current_element = new Request(Request::GET);
                    break;
                case 'POST {':
                    $current_element = new Request(Request::POST);
                    break;
                case 'PUT {':
                    $current_element = new Request(Request::PUT);
                    break;
                case 'DELETE {':
                    $current_element = new Request(Request::DELETE);
                    break;
                case 'SLEEP {':
                    $current_element = new Sleep();
                    break;
